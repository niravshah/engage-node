...
(function($) {
    ...
    function scrolldown() {
        ...
        if(header_h >= 650) scrolldown.show();
    ...
    $(document).ready(function() {
        ...
        $('#subscribe').ajaxChimp({
            language: 'lj',
            url: 'http://letsengage.us9.list-manage.com/subscribe/post?u=0554c5a2aac8f0e0711f7dfc4&amp;id=d32fb04d89'
        });
        ...
        Parse.initialize("uvg8lkUiG9eUfT0WLZRRb0whwmUusJs48jV1595s", "iySNnUSas5TUEWXZKJ3CVjlFfslp9H0KmOe4WyDS");
                ...
                if(name == "" || email == "" || message == "") {
                    ...
                    ctcObj.save({
                        ...
                        error: function(model, error) {
                            $(".lj-contact-message").html('<i class="fa fa-check"></i> Error!');
                        }
                    });
                }
            });
        ...
        $(function() {
            var endDate = "January 15, 2015 10:00:00";
        ...
        // backstretch
        $("header").backstretch("img/bg-1.jpg");
        // JQUERY.MB.YTPLAYER
        /*
    $(function(){
